...
\title{USENIX Security '25 Artifact Appendix: Exposing and Circumventing SNI-based QUIC Censorship of the Great Firewall of China}



% Todo: Update with your names and affiliations
\author{
{\rm Ali Zohaib}\footnotemark[1]\\
University of Massachusetts Amherst
\and
{\rm Qiang Zao}\footnotemark[1]\\
GFW Report
\and
{\rm Jackson Sippe}\\
University of Colorado Boulder
\and
{\rm Abdulrahman Alaraj}\\
University of Colorado Boulder
\and
{\rm Amir Houmansadr}\\
University of Massachusetts Amherst
...
\def\thefootnote{*}\footnotetext{Ali Zohaib and Qiang Zao contributed equally to this work.}\def
